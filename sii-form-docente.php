        ...
        <div class="pb-5">
          <div class="row">
            <div class="col-sm-12 col-md-6 text-center">
              <h2 class="mt-2"><br>Portal de Docentes</h2>
              <?php
                include "CONF/conexion.php";
                include "PHP/controlador-login-docente.php";
              ?>
              <form action="" method="post">
                <div class="form-group mt-5">
                  <label for="input">Ingrese sus datos</label>
                  <input id="input" class="form-control" type="text" name="usuario" placeholder="CURP">
                </div>
                <div class="form-group mt-5">
