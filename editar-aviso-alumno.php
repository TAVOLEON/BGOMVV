...
include "PHP/contrl-editar-aviso-alumnos.php";
$curp=$_SESSION['curp'] ;
        ...
        <div id="content">
          <section>
            <div class="container">
              <div class="row">
                <div class="col-lg-9">
                  <h1 class="font-weight-bold mt-2 mb-0">Editar Aviso</h1>
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-lg-9 ">
                        ...
                        <?php 
                            include "CONF/conexion.php";
                            $sql=$conexion->query("SELECT * FROM anuncios_alumnos WHERE id='$id'");
                         ...
                         ?> 
                          ...
                          <div class="form-group">
                            ...
                            <input id="nombre" class="form-control" type="text" name="titulo" value="<?=$datos->titulo?>">
                          </div>
                          <div class="form-group">
