...
$sqlfoto=$conexion->query("SELECT foto FROM info_personal_alumnos WHERE matricula='$matricula'");
?>
<script>
function eliminar(){
            ...
            <div class="container mt-2">
              <div class="row">
                <div class="col-lg-12 ">
                  ...
                  <h5 class="font-weight-bold mb-0"> <?php echo $_SESSION["nombre"] ," ", $_SESSION["apellidop"]," ", $_SESSION["apellidom"];?></h5>
                  <h6 class="font-weight-bold mb-0"> <?php echo $_SESSION["matricula"];?></h6>
                </div>
