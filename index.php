...
while ($datos = $sql->fetch_object()) { ?>
  <section id="inicio" class="">
    <div class="jumbotron pb-5">
      <h1 class="display-4 pt-5 pl-5"> <strong><?= $datos->titulo ?></strong></h1>
      <p class="lead pl-5"><?= $datos->subtitulo ?></p>
  ...
  <!-- SECCION DE ANUNCIOS -->
  <section id="noticias">
    <h1 class="text-center text-noticias">Noticias</h1>
    <?php include "CONF/conexion.php";
    $sql = $conexion->query("SELECT * FROM anuncios_home");
    while ($datos = $sql->fetch_object()) { ?>
      <div class="card mt-3 ">
        <div class="card-header text-center titulo-card">
          <?= $datos->titulo ?>
        </div>
        <div class="card-body ">
          <div class="d-flex justify-content-center">
            <div class="info col-lg-5 col-md-6>
        ...
        <div class="card-footer text">
          <h6 class="text-muted text-center">Fecha: <?= $datos->fecha ?></h6>
        </div>
      <?php
    } ?>
      </div>
        ...
        while ($datos = $sql->fetch_object()) { ?>
          <section id="calendario">
            <div class="container text-center">
              <h1 class="mt-5 text-calendario"><?= $datos->titulo ?></h1>
          ...
          while ($datos = $sql->fetch_object()) { ?>
            ...
            while ($datos = $sql->fetch_object()) { ?>
              <section id="docentes2">
                <div class="container">
                  <h1 class="text-center mt-5 text-docentes"><?= $datos->titulo ?></h1>
              ...
              while ($datos = $sql->fetch_object()) { ?>
                ...
                while ($datos = $sql->fetch_object()) { ?>
                  <section id="Mision">
                    <div class="container">
                      <h1 class="text-center mt-5 text-mision"><?= $datos->titulo ?></h1>
                      <div class="row mt-2">
                        ...
                        <div class="container">
                          ...
                          <div class="row mt-3">
                            ...
                            while ($datos = $sql->fetch_object()) { ?>
                              <div class="col-sm-12 col-md-4 text-center mb-5 pt-3">
                                <div>
                                  <h2 class="mt-2 text-valores"><i class="fas fa-paint-brush"></i><br><?= $datos->titulo ?></h2>
                                  <p class="mt-2"><?= $datos->subtitulo ?></p>
                                  <p class="mt-2"><?= $datos->cuerpo ?></p>
                                </div>
                              <?php
