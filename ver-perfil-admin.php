...
$curp= $_SESSION["curp"];
$curpadmin= $_GET["curp"];
$sql=$conexion->query("SELECT * FROM administradores WHERE curp='$curpadmin'");
$sql2=$conexion->query("SELECT * FROM info_personal_admin WHERE curp='$curpadmin'");
?>
            ...
            <div class="container">
              <div class="row">
                <div class="col-lg-9">
                  ...
                  <p class="lead text-muted">CURP : <?=$curpadmin?> </p>
                </div>
              </div>
            </div>
          </section>
