...
include "PHP/ctrl-editar-salon.php";
        ...
        <div id="content">
          <section>
            <div class="container">
              <div class="row">
                <div class="col-lg-9">
                  <h1 class="font-weight-bold mt-2 mb-0">Editar Salon</h1>
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-lg-9 ">
                        ...
                        <?php 
                            include "CONF/conexion.php";
                            $sql=$conexion->query("SELECT * FROM salones WHERE nombre='$nombre'");
                         ...
                         ?> 
                          ...
                          <div class="form-group">
                            ...
                            <input id="descripcion" class="form-control" type="text" name="descripcion" value="<?=$datos->descripcion?>">
                          </div>
                          <div class="form-group">
                            <label for="responsable">Responsable</label>
                            <input id="responsable" class="form-control" type="text" name="responsable" value="<?=$datos->responsable?>">
                          </div>
                          <div class="form-group">
